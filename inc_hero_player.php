...
<div class="hero-player">
	<div class="ci-soundplayer <?php echo ! empty( $s_url ) ? 'ci-streaming ' : ''; echo esc_attr( $autoplay . $current_track ); ?>">
			...
			<?php else: ?>
				<?php
					foreach( $tracklisting as $track ) {
						...
						?>
						<li><a class="inline-exclude" href="<?php echo esc_url( $track['play_url'] ); ?>"><?php echo $track['title'] . ' - ' . $track['subtitle']; ?></a></li><?php
					}
				?>
			<?php endif; ?>
		</ol>
