...
{
	$labels = array(
		'name'               => _x( 'In Club Entertainment', 'post type general name', 'ci_theme' ),
		'singular_name'      => _x( 'In Club Entertainment Item', 'post type singular name', 'ci_theme' ),
		'add_new'            => __( 'Add New', 'ci_theme' ),
		'add_new_item'       => __( 'Add New In Club Entertainment Item', 'ci_theme' ),
		'edit_item'          => __( 'Edit In Club Entertainment Item', 'ci_theme' ),
		'new_item'           => __( 'New In Club Entertainment Item', 'ci_theme' ),
		'view_item'          => __( 'View In Club Entertainment Item', 'ci_theme' ),
		'search_items'       => __( 'Search In Club Entertainment Items', 'ci_theme' ),
		'not_found'          => __( 'No In Club Entertainment Items found', 'ci_theme' ),
		'not_found_in_trash' => __( 'No In Club Entertainment Items found in the trash', 'ci_theme' ),
		'parent_item_colon'  => __( 'Parent In Club Entertainment Item:', 'ci_theme' )
	);

	$args = array(
		'labels'          => $labels,
		'singular_label'  => __( 'In Club Entertainment Item', 'ci_theme' ),
		'public'          => true,
		'show_ui'         => true,
		'capability_type' => 'post',
		'hierarchical'    => false,
		'has_archive'     => _x( 'In Club Entertainment', 'post type archive slug', 'ci_theme' ),
...
function discography_add_meta_boxes() {
	add_meta_box( 'discography-box', __( 'In Club Entertainment Settings', 'ci_theme' ), 'discography_score_meta_box', 'cpt_discography', 'normal', 'high' );
}
endif;
...
function discography_score_meta_box( $object, $box )
{
	...
	?><div class="ci-cf-wrap"><?php
		ci_metabox_open_tab( __( 'In Club Event Details', 'ci_theme' ) );
			ci_metabox_input( 'ci_cpt_discography_date', __( 'Event date:', 'ci_theme' ) );
    			ci_metabox_input( 'ci_cpt_discography_label', __( 'Location:', 'ci_theme' ) );
    			ci_metabox_input( 'ci_cpt_discography_cat_no', __( 'Cost:', 'ci_theme' ) );

			
		ci_metabox_close_tab();

		ci_metabox_open_tab( __( 'Button Details', 'ci_theme' ) );
			ci_metabox_input( 'ci_cpt_discography_purchase_text', __( 'Call to action text. For example: "You can purchase these tickets now"', 'ci_theme' ) );
			ci_metabox_input( 'ci_cpt_discography_purchase_text_from1', __( 'Button text', 'ci_theme' ) );
			ci_metabox_input( 'ci_cpt_discography_purchase_text_url1', __( 'Button URL', 'ci_theme' ), array( 'esc_func' => 'esc_url' ) );
		ci_metabox_close_tab();
