...
class CI_Events extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
		    ...
		    __( '-= CI Recent Events =-', 'ci_theme' ), // Name
		...
		while ( $latest_events->have_posts() ) : $latest_events->the_post();
			...
			<li class="group">
				...
				<div class="tour-place">
					<span class="sub-head"><?php if ($post->post_content != ''): ?><a href="<?php the_permalink(); ?>" <?php echo $event_new_win; ?>><?php endif; ?><?php echo $event_venue; ?><?php if ($post->post_content != ''): ?></a><?php endif; ?></span>
