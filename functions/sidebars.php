...
function ci_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Header Sidebar', 'ci_theme' ),
		'id'            => 'header-widgets',
		'description'   => __( 'Displays widgets on the right hand side of your header. Specifically made for the Socials Ignited Plugin Widget or a Search Bar.', 'ci_theme' ),
		'before_widget' => '<div id="%1$s" class="%2$s widget group">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>'
	...
	register_sidebar( array(
		...
		'id'            => 'events-sidebar',
		'description'   => __( 'Place here the widgets that you want to display on your events listing sidebar', 'ci_theme' ),
		'before_widget' => '<div id="%1$s" class="%2$s widget group">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>'
